# solución planteada para 1000 muestras de tamaño n
n<-10000
x<-rnorm(10000, mean=20, sd=5)
# espacio muestral: una población normal de mu=20 y sigma:25
m<-matrix(nrow=n,ncol=50, NA)
for (k in 1:10000){
m[k,]<-sample(x,50)
}
View(m)
#hallamos el estadístico de prueba: media muestral
vm<-matrix(nrow=10000, ncol=1, NA)
for(i in 1:10000){ 
vm[i,]<-mean(m[i,])
} 
View(vm)
# prueba de hipótesis Ho: mu=20 vs H1:mu>20
alpha<-0.05
mu=20
sigma=25
